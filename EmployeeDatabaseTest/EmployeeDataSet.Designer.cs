...
namespace EmployeeDatabaseTest {
    ...
    public partial class EmployeeDataSet : global::System.Data.DataSet {
        ...
        public partial class employeeDataTable : global::System.Data.TypedTableBase<employeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public employeeRow AddemployeeRow(int id, string firstName, string lastName, int yearsOfService) {
        ...
        public partial class employeeRow : global::System.Data.DataRow {
            ...
            public int yearsOfService {
                get {
                    try {
                        return ((int)(this[this.tableemployee.yearsOfServiceColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'yearsOfService\' in table \'employee\' is DBNull.", e);
                    }
                }
                set {
...
namespace EmployeeDatabaseTest.EmployeeDataSetTableAdapters {
    ...
    public partial class employeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[employee] ([id], [firstName], [lastName], [yearsOfService]) VA" +
                "LUES (@id, @firstName, @lastName, @yearsOfService);\r\nSELECT id, firstName, lastN" +
                "ame, yearsOfService FROM employee WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[employee] SET [id] = @id, [firstName] = @firstName, [lastName] = @lastName, [yearsOfService] = @yearsOfService WHERE (([id] = @Original_id) AND ((@IsNull_firstName = 1 AND [firstName] IS NULL) OR ([firstName] = @Original_firstName)) AND ((@IsNull_lastName = 1 AND [lastName] IS NULL) OR ([lastName] = @Original_lastName)) AND ((@IsNull_yearsOfService = 1 AND [yearsOfService] IS NULL) OR ([yearsOfService] = @Original_yearsOfService)));
SELECT id, firstName, lastName, yearsOfService FROM employee WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::EmployeeDatabaseTest.Properties.Settings.Default.EmployeeConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, firstName, lastName, yearsOfService FROM dbo.employee";
        ...
        public virtual int Delete(int Original_id, string Original_firstName, string Original_lastName, global::System.Nullable<int> Original_yearsOfService) {
            ...
            if ((Original_yearsOfService.HasValue == true)) {
                this.Adapter.DeleteCommand.Parameters[5].Value = ((object)(0));
                this.Adapter.DeleteCommand.Parameters[6].Value = ((int)(Original_yearsOfService.Value));
            }
            else {
        ...
        public virtual int Insert(int id, string firstName, string lastName, global::System.Nullable<int> yearsOfService) {
            ...
            if ((yearsOfService.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[3].Value = ((int)(yearsOfService.Value));
            }
            else {
        ...
        public virtual int Update(int id, string firstName, string lastName, global::System.Nullable<int> yearsOfService, int Original_id, string Original_firstName, string Original_lastName, global::System.Nullable<int> Original_yearsOfService) {
            ...
            if ((yearsOfService.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(yearsOfService.Value));
            }
            else {
            ...
            if ((Original_yearsOfService.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((int)(Original_yearsOfService.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string firstName, string lastName, global::System.Nullable<int> yearsOfService, int Original_id, string Original_firstName, string Original_lastName, global::System.Nullable<int> Original_yearsOfService) {
            return this.Update(Original_id, firstName, lastName, yearsOfService, Original_id, Original_firstName, Original_lastName, Original_yearsOfService);
        }
    }
